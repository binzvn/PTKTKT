    ...
    <div className="wrapper-home d-flex flex-column">
      ...
      <div className="middle-page">
        <div className="content-middle p-5">
          <p className="txt-blue">Thông báo</p>
          <div className="title-chat d-flex justify-content-between">
            <h4 className="txt-black fw-bold">Thông báo</h4>
            <p className="txt-blue me-5 fw-bold">Xóa</p>
          </div>
          <div className="box1">
          <div className="box-notif p-3 mt-3">
            <p className="txt-black fw-bold">Chúc mừng</p>
